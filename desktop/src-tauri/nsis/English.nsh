...
LangString appRunning ${LANG_ENGLISH} "Reasonix is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "Reasonix is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill Reasonix. Please close it first then try again"
